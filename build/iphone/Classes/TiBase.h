...
// in simulator we redefine to format for EuroPom Developer console
...
{\
	NSString * exceptionName = [@"org.europom." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.europom";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIEuroPomNativeItemNone = -1, 
	UIEuroPomNativeItemSpinner = -2,
	UIEuroPomNativeItemProgressBar = -3,
	
	UIEuroPomNativeItemSlider = -4,
	UIEuroPomNativeItemSwitch = -5,
	UIEuroPomNativeItemMultiButton = -6,
	UIEuroPomNativeItemSegmented = -7,
	
	UIEuroPomNativeItemTextView = -8,
	UIEuroPomNativeItemTextField = -9,
	UIEuroPomNativeItemSearchBar = -10,
	
	UIEuroPomNativeItemPicker = -11,
	UIEuroPomNativeItemDatePicker = -12,
	
	UIEuroPomNativeItemInfoLight = -13,
	UIEuroPomNativeItemInfoDark = -14,
	
	UIEuroPomNativeItemDisclosure = -15,
	
	UIEuroPomNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all EuroPom instances of
