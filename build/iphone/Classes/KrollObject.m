...
//@interface EuroPomObject : NSObject
//@end

@interface EuroPomObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[EuroPomObject class]])
		{
			for (NSString *key in [[(EuroPomObject*)o modules] allKeys])
			{
